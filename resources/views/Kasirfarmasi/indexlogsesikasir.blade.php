    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="v_1">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-success" style="margin-top:32px"
                                        onclick="tampilkandatasesi()"><i class="bi bi-search"
                ...
                <div class="card mt-4">
                    <div class="card-header"><i class="bi bi-database-fill-check " style="margin-right: 8px"></i> Tabel log Sesi Kasir</div>
                    <div class="card-body">
