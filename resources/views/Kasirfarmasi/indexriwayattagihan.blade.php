...
@section('container')
    <div class="app-content-header">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Riwayat tagihan pasien</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Riwayat tagihan pasien</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="v_1">
                ...
                <div class="card mt-4">
                    <div class="card-header"><i class="bi bi-database-fill-check " style="margin-right: 8px"></i> Tabel Riwayat tagihan pasien</div>
                    <div class="card-body">
    ...
    <script>
        ...
        function tampilkandatapasien() {
            ...
            $.ajax({
                ...
                url: '<?= route('ambilriwayattagihanpasien') ?>',
